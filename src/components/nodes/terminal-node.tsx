...
function TerminalNodeComponent({ id, data }: NodeProps<TerminalNodeType>) {
  ...
  return (
    ...
    >
      {glow ? (
        <motion.span
          aria-hidden
          className="pointer-events-none absolute z-0 h-[250px] w-[250px] rounded-full border-[12px] border-purple-400/30"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
