        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="font-inria-sans mb-6 text-4xl font-bold text-white md:text-5xl lg:text-6xl">
              Our <span className="text-[#FF8F27]">Mission</span>
            </h1>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="rounded-xl bg-[#0B101D] p-6">
                ...
                <p className="font-inria-sans text-sm leading-relaxed text-white/70">
                  People aren&apos;t struggling because they lack drive. They&apos;re
                  surrounded by information that never gives them clarity or
                  confidence.
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#1D2740] py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="font-inria-sans mb-10 text-lg leading-relaxed text-white/80">
