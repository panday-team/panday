...
categories:
  ...
  - id: "foundation-program-roadblocks"
    ...
    icon: "traffic-cone"
    nodes:
      - id: "foundation-roadblock-wait-lists"
        type: "checklist"
        title: "Wait Lists & Acceptance"
        nodeType: "checklist"
        labelPosition: "left"
---
...
- **First-come, first-served**: Early applicants get priority (seats fill quickly)
- **Prerequisite requirements**: Grade 12, especially Math 11/12, narrows eligible pool
...
- **Regional colleges**: Often shorter (2-6 months)
...
- May require relocation (consider costs vs. wait time)
...
- Some helper experience may be recognized as work hours later
...
- Math refresher (fractions, algebra, geometry)
...
4. **Month 13**: Find employer sponsor (70%+ job placement rate)
5. **Year 2-5**: Complete Levels 2-4 and Red Seal
...
4. **Years 2-5**: Complete Levels 2-4 and Red Seal

**Time to Red Seal**: ~5-6 years total (similar to foundation, but starts earning immediately)

**Key Difference**: Foundation = 6 months waiting + 6 months training = 1 year before starting work. Direct entry = start earning immediately but may take 3-6 months to find sponsor.

## Resources

- [BCIT Electrical Foundation](https://www.bcit.ca/programs/electrical-foundation-certificate-full-time-1780cert/) - Application portal and requirements
...
- [VIU Trades](https://www.viu.ca/trades-applied-technology) - Nanaimo foundation program
- [SkilledTradesBC Approved Providers](https://skilledtradesbc.ca/all-approved-training-providers-list) - Full list of accredited programs
- [BC Adult Upgrading](https://www2.gov.bc.ca/gov/content/education-training/adult-education/upgrade-skills) - Math/English upgrading options

## Key Insight

**Wait lists are frustrating but not insurmountable.** Successful applicants apply early to multiple programs, use wait time productively to build savings and skills, and always have a backup plan (direct entry). If waiting exceeds 12 months, seriously consider direct entry—the time and income lost waiting may outweigh foundation program's benefits. Remember: Foundation is a **recommended** path, not the only path to Red Seal certification.
